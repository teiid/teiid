...
/**
 * An interface that can be implemented and supplied to DialogFactoryCallbackHandler to
 * provide the currently active frame overwhich a callback dialog needs to display.
 */
