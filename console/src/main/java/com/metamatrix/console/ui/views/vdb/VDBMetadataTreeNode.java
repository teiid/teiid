...
public class VDBMetadataTreeNode extends DefaultMutableTreeNode {
        ...
        public VDBMetadataTreeNode(String nodeName,
                PermissionDataNode correspondingTreeNode) {
            super(nodeName);
            this.correspondingTreeNode = correspondingTreeNode;
        }
        ...
        public boolean parentIsRoot() {
            ...
            VDBMetadataTreeNode parent = (VDBMetadataTreeNode)this.getParent();
            if (parent != null) {
