...
public class LDAPMembershipDomain implements
    ...
    public void initialize(Properties props) throws ServiceStateException {
        ...
        if (ldapURL == null) {
            throw new ServiceStateException(PlatformPlugin.Util.getString("LDAPMembershipDomain.Required_property", LDAP_URL)); //$NON-NLS-1$
        }
    ...
    private List buildContexts(String rootContextsProp,
                               ...
                               String memberOfAttributeProp, String defaultDisplayName, Properties props) throws ServiceStateException {
        
        String rootContextsStr = props.getProperty(rootContextsProp, null);
        if (rootContextsStr == null) {
            throw new ServiceStateException(PlatformPlugin.Util.getString("LDAPMembershipDomain.Required_property", rootContextsProp)); //$NON-NLS-1$
        }
