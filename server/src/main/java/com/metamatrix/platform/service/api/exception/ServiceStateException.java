...
/**
 *  This exception will be thrown when a request is made to a service that is not in
 * a ready state.
 */
public class ServiceStateException extends ServiceException {
     ...
     */
    public ServiceStateException( String code, String message ) {
        super( code, message );
    }
     ...
     */
    public ServiceStateException( Throwable e, String message ) {
        super( e, message );
    }
     ...
     * @param code A code denoting the exception
     */
    public ServiceStateException( Throwable e, String code, String message ) {
     ...
     */
    public ServiceStateException(Throwable e) {
        super(e);
    }
}
