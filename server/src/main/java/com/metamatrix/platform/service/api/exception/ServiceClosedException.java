...
public class ServiceClosedException extends ServiceStateException {
     ...
     */
    public ServiceClosedException( String code, String message ) {
        super( code, message );
    }
     ...
     */
    public ServiceClosedException( Throwable e, String message ) {
        super( e, message );
    }
     ...
     * @param code A code denoting the exception
     */
    public ServiceClosedException( Throwable e, String code, String message ) {
     ...
     */
    public ServiceClosedException(Throwable e) {
        super(e);
    }
}
