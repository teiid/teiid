 ...
 */
public class ServiceSuspendedException extends ServiceStateException {
     ...
     */
    public ServiceSuspendedException( String code, String message ) {
        super( code, message );
    }
     ...
     */
    public ServiceSuspendedException( Throwable e, String message ) {
        super( e, message );
    }
     ...
     * @param code A code denoting the exception
     */
    public ServiceSuspendedException( Throwable e, String code, String message ) {
     ...
     */
    public ServiceSuspendedException(Throwable e) {
        super(e);
    }
}
