...
public class JDBCExtensionModuleTransactionFactory implements TransactionFactory {

    public JDBCExtensionModuleTransactionFactory() {
    }
    ...
    throws ManagedConnectionException {
        return new JDBCExtensionModuleTransaction(connection,readonly);
    }
