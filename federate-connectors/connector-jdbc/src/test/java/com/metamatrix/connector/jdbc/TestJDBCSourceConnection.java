...
public class TestJDBCSourceConnection extends TestCase {
    ...
    /**
     * Tests JDBCSourceConnection.isConnectionFailed() with a ConnectionQueryStrategy
     * @since 4.3
     */
    public void testIsFailed() throws Exception {
        ...
        fakeConnection.closed = false;
        assertFalse(sourceConnection.isFailed());
        ...
        fakeConnection.closed = false;
        fakeConnection.fail = true;
        assertTrue(sourceConnection.isFailed());
    ...
    /**
     * Tests JDBCSourceConnection.isConnectionFailed() with a null ConnectionStrategy
     * @since 4.3
     */
    public void testIsFailedNullStrategy() throws Exception {
        JDBCSourceConnection sourceConnection = new JDBCSourceConnection(connection, environment, null); 
