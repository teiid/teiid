...
public class MaterializationLoadScriptsImpl implements MaterializationLoadScripts, Serializable {
    ...
    public void setLoadScript(final String fileName, final byte[] fileContents) {
        if ( fileName == null ) {
            throw new MetaMatrixRuntimeException(AdminPlugin.Util.getString("MaterializationLoadScriptsImpl.null_load_script_file_name")); //$NON-NLS-1$
        }
        if ( fileContents == null || fileContents.length == 0 ) {
            throw new MetaMatrixRuntimeException(AdminPlugin.Util.getString("MaterializationLoadScriptsImpl.null_load_script_file_contents")); //$NON-NLS-1$
        }
