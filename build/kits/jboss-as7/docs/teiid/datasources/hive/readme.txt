...
3) Then copy need hive jar files defined in the "<jboss-as>/modules/system/layers/base/org/apache/hadoop/hive/main/modules.xml" file into  
"<jboss-as>/modules/system/layers/base/org/apache/hadoop/hive/main" directory.
