...
/**
 */
public class FakeObjectValueTranslator extends  SourceInterfaceValueTranslator {
...
//    private static Map usedMethods = new HashMap();
    ...
    public FakeObjectValueTranslator(Class sourceInterfaceClass) {
        super(sourceInterfaceClass);
    }
    
    
    /** 
     * @param sourceInterfaceClass
     * @param targetInterfaceClass
     * @since 4.3
     */
    public FakeObjectValueTranslator(Class sourceInterfaceClass,
                                     Class targetInterfaceClass) {
        super(sourceInterfaceClass, targetInterfaceClass);
    }
