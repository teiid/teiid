...
/**
 */
public class FakeSysAdminConnectionFactory implements ISysAdminConnectionFactory {
    ...
    public ISysAdminSource getObjectSource(SecurityContext context) throws ConnectorException {
            ...
            try {       
                Object o = FakeObjectUtil.getInstance(context.getUser(), context.getConnectionIdentifier());
