 ...
 * @since 4.3
 */
public class FakeObjectSourceTranslator extends SysAdminSourceTranslator{
    private static Class TESTOBJECT_CLASS = FakeObject.class; 
    //    (new FakeObject()).getClass();
    
    public FakeObjectSourceTranslator(Class clzz) {
        super(clzz);
    }
    ...
    public void initialize(ConnectorEnvironment env) throws ConnectorException {
      ...
      valueTranslator = new SourceInterfaceValueTranslator(TESTOBJECT_CLASS, TESTOBJECT_CLASS);
