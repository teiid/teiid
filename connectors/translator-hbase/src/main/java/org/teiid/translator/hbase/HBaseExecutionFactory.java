...
public class HBaseExecutionFactory extends JDBCExecutionFactory {
    ...
    public void start() throws TranslatorException {
        ...
        registerFunctionModifier(SourceSystemFunctions.PARSEDATE, new AliasModifier("TO_DATE")); //$NON-NLS-1$
        registerFunctionModifier(SourceSystemFunctions.PARSETIME, new AliasModifier("TO_TIME")); //$NON-NLS-1$
        ...
        addPushDownFunction(HBASE, "CONVERT_TZ", TIMESTAMP, TIMESTAMP, STRING, STRING); //$NON-NLS-1$
    }
