...
public class N1QLVisitor extends SQLStringVisitor{
    ...
    private List<String> selectColumnReferences = new ArrayList<String>();
    ...
    private List<CBColumn> unrelatedStack = new ArrayList<CBColumn>();
    
    private List<CBColumn> tmpStack = new ArrayList<CBColumn>();
    ...
    private void appendWhere(Select obj) {
        ...
        if(this.typedName != null && this.typedValue != null) {
            ...
            List<CBColumn> typedColumn = new ArrayList<CBColumn>();
