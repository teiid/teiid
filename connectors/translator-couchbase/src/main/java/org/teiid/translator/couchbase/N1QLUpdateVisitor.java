...
public class N1QLUpdateVisitor extends N1QLVisitor {
    ...
    public void visit(Insert obj) {
        ...
        List<Parameter> preparedValues = new ArrayList<Parameter>();
...
//            }
    ...
    private void appendBulkValues(List<Parameter> preparedValues, List<CBColumnData> rowCache, Insert command) {
        ...
        int cursor = 0;
        List<String> n1qlList = new ArrayList<String>();
    ...
    private String buildNestedArrayIdx(LanguageObject obj, List<CBColumnData> rowCache) {
        ...
        List<CBColumnData> idxList = new ArrayList<CBColumnData>(dimension);
        for(CBColumnData columnData : rowCache) {
    ...
    public void visit(Delete obj) {
        ...
        if(isArrayTable) {// delete array depend on array index, and optional docuemntID
            ...
            List<CBColumnData> idxList = new ArrayList<CBColumnData>(dimension);
            List<CBColumnData> equalityWhereList = new ArrayList<CBColumnData>(rowCache.size());
            for(CBColumnData columnData : rowCache) {
                if(columnData.getCBColumn().isIdx()) {
                    idxList.add(columnData);
            ...
            Object o = idxList.get(idxList.size() -1).getValue();
            int idx = Integer.valueOf((String) o);
//            int idx = (int)idxList.get(idxList.size() -1).getValue();
    ...
    public void visit(Update obj) {
        ...
        if(isArrayTable) {
            ...
            List<CBColumnData> setList = new ArrayList<CBColumnData>(rowCache.size());
            for(int i = 0 ; i < rowCache.size() ; i ++) {
            ...
            List<CBColumnData> idxList = new ArrayList<CBColumnData>(dimension);
            List<CBColumnData> equalityWhereList = new ArrayList<CBColumnData>(whereRowCache.size());
