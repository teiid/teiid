...
import org.teiid.translator.object.infinispan.InfinispanCacheWrapper;
...
public class InfinispanManagedConnectionFactory extends
				...
				try {
					Thread.currentThread().setContextClassLoader(this.getClass().getClassLoader());
						...
						return new InfinispanConnectionImpl(
								InfinispanManagedConnectionFactory.this);
	...
	public void setCacheTypeMap(String cacheTypeMap) {
	 ...
	 /**
	 * Sets the (optional) module(s) where the ClassName class is defined,
	 that will be loaded <code> (module,[module,..])</code>
	 * @param module
	 * @see #getModule
	 */
	...
	protected CacheContainerWrapper getCacheContainer() {
	...
	private CacheContainerWrapper createRemoteCacheFromServerList(ClassLoader classLoader)
			throws ResourceException {
	...
	private CacheContainerWrapper createRemoteCache(Properties props,
			ClassLoader classLoader) throws ResourceException {
		RemoteCacheManager remoteCacheManager;
		try {
			remoteCacheManager = new RemoteCacheManager(new PojoMarshaller(classLoader), props, true);
		} catch (Exception err) {
...
class LocalCacheWrapper extends InfinispanCacheWrapper {
...
class RemoteCacheWrapper extends InfinispanCacheWrapper {
