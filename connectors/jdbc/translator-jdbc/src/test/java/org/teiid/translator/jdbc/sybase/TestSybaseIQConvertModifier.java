...
public class TestSybaseIQConvertModifier {
    ...
    @Test public void testStringToDate() throws Exception {
        ...
        assertEquals("cast('2003-12-31' AS date)", helpGetString(func)); //$NON-NLS-1$
    }
    ...
    @Test public void testTimestampToDate() throws Exception {
        ...
        helpGetString1(func,  "cast(CAST('1989-03-03 07:08:12.0' AS TIMESTAMP) AS date)");  //$NON-NLS-1$
    }
    ...
    @Test public void testStringToTime() throws Exception {
        ...
        helpGetString1(func,  "cast('12:08:07' AS time)");  //$NON-NLS-1$
    }
    ...
    @Test public void testTimestampToTime() throws Exception {
        ...
        helpGetString1(func,  "cast(CAST('1989-03-03 07:08:12.0' AS TIMESTAMP) AS time)");  //$NON-NLS-1$
    }
    ...
    @Test public void testStringToTimestamp() throws Exception {
        ...
        helpGetString1(func,  "cast('1989-07-09 12:08:07' AS timestamp)");  //$NON-NLS-1$
    }
    ...
    @Test public void testTimeToTimestamp() throws Exception {
        ...
        helpGetString1(func,  "cast(CAST('12:02:03' AS TIME) AS timestamp)");  //$NON-NLS-1$
    }
    ...
    @Test public void testDateToTimestamp() throws Exception {
        ...
        helpGetString1(func,  "cast(CAST('1989-03-03' AS DATE) AS timestamp)");  //$NON-NLS-1$
    }
    ...
    @Test public void testTimeToString() throws Exception {
        ...
        helpGetString1(func,  "convert(varchar, CAST('03:10:01' AS TIME), 8)");  //$NON-NLS-1$
    }
    ...
    @Test public void testStringToLong() throws Exception {
        ...
        helpGetString1(func,  "cast('12332131413' AS bigint)");  //$NON-NLS-1$
    }
    ...
    @Test public void testBooleanToLonga() throws Exception {
        ...
        helpGetString1(func, "cast(1 AS bigint)"); //$NON-NLS-1$
    }
    ...
    @Test public void testStringToDouble() throws Exception {
        ...
        helpGetString1(func,  "cast('123' AS double)");  //$NON-NLS-1$
    }
    ...
    @Test public void testBooleanToDoublea() throws Exception {
        ...
        helpGetString1(func, "cast(1 AS double)"); //$NON-NLS-1$
    }
    ...
    @Test public void testBooleanToDoubleb() throws Exception {
        ...
        helpGetString1(func, "cast(0 AS double)"); //$NON-NLS-1$
    }
    ...
    @Test public void testBooleanToLong() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(Boolean.TRUE, Boolean.class), "long", "cast(1 AS bigint)"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testBooleanToDouble() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(Boolean.TRUE, Boolean.class), "double", "cast(1 AS double)"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testByteToLong() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new Byte((byte)1), Byte.class), "long", "cast(1 AS bigint)"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testByteToDouble() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new Byte((byte)1), Byte.class), "double", "cast(1 AS double)"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testShortToLong() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new Short((short)1), Short.class), "long", "cast(1 AS bigint)"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testShortToDouble() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new Short((short)1), Short.class), "double", "cast(1 AS double)"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testIntegerToLong() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new Integer(1), Integer.class), "long", "cast(1 AS bigint)"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testIntegerToDouble() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new Integer(1), Integer.class), "double", "cast(1 AS double)"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testLongToDouble() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new Long(1), Long.class), "double", "cast(1 AS double)"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testBigIntegerToLong() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new BigInteger("1"), BigInteger.class), "long", "cast(1 AS bigint)"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
    ...
    @Test public void testBigIntegerToDouble() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new BigInteger("1"), BigInteger.class), "double", "cast(1 AS double)"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
    ...
    @Test public void testFloatToDouble() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new Float(1.2f), Float.class), "double", "cast(1.2 AS double)"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testDoubleToLong() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new Double(1.2), Double.class), "long", "cast(1.2 AS bigint)"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testBigDecimalToLong() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new BigDecimal("1.0"), BigDecimal.class), "long", "cast(1.0 AS bigint)"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
    ...
    @Test public void testBigDecimalToDouble() throws Exception {
        helpTest(LANG_FACTORY.createLiteral(new BigDecimal("1.0"), BigDecimal.class), "double", "cast(1.0 AS double)"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
