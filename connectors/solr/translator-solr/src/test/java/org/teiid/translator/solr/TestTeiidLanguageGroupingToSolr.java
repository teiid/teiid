...
public class TestTeiidLanguageGroupingToSolr {
	...
	private QueryMetadataInterface setUp(String ddl, String vdbName,
        ...
        this.utility.addUDF(CoreConstants.SYSTEM_MODEL, translator.getPushDownFunctions());
		return metadata;
	}
	...
	@Before public void setUp() throws IOException, Exception {
	    setUp(ObjectConverterUtil.convertFileToString(UnitTestUtil.getTestDataFile("exampleTBL.ddl")), "exampleVDB","exampleModel");
