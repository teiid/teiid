...
public class TestHanaConvertModifier {
    ...
    private static HanaExecutionFactory TRANSLATOR = new HanaExecutionFactory(); 
    ...
    public String helpGetString(Expression expr) throws Exception {
    	HanaExecutionFactory trans = new HanaExecutionFactory();
        trans.start();
    ...
    public void helpTest(Expression srcExpression, String tgtType, String expectedExpression) throws Exception {
        Function func = LANG_FACTORY.createFunction("to_"+tgtType,  //$NON-NLS-1$
            Arrays.asList( 
                srcExpression,
