...
public class TestN1QLVisitor extends TestVisitor {
    ...
    public void testConversionFunctions() throws TranslatorException {
        ...
        sql = "SELECT convert(attr_string, date) AS DateValue, convert(attr_string, time) AS TimeValue, convert(attr_string, timestamp) AS TimstampValue FROM T2";
        helpTest(sql, "N1QL1107");
    }
