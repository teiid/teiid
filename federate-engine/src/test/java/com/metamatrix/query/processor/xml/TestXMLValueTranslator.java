...
public class TestXMLValueTranslator extends TestCase {
    ...
    public void test24HourDateTimeTranslation() {
        Timestamp ts = util.createTimestamp(100, 0, 2, 14, 14, 5, 6);
    ...
    public void testDateTimeTranslation() {
        Timestamp ts = util.createTimestamp(100, 0, 2, 3, 4, 5, 6);
        ...
        ts = util.createTimestamp(-2000, 0, 2, 3, 4, 5, 6);
    ...
    public void testgYearTranslation() {
        try {
        ...
        try {
            String value = XMLValueTranslator.translateToXMLValue(new BigInteger("-10000"), DataTypeManager.DefaultDataClasses.BIG_INTEGER, XMLValueTranslator.GYEAR); //$NON-NLS-1$
    ...
    public void testgYearMonthTranslation() {
        Timestamp ts = util.createTimestamp(100, 0, 4, 6, 8, 10, 12);
        ...
        ts = util.createTimestamp(-30000, 0, 4, 6, 8, 10, 12);
