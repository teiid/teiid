...
//            Arrays.asList(new Object[] { "a",   new Integer(0),     Boolean.FALSE,  new Double(2.0),  null })
   ...
   public void testCase4() { 
    ...
    public void testXQueryView1() {
        ...
        // Plan query
        ProcessorPlan plan = helpGetPlan(sql, FakeMetadataFactory.exampleXQueryTransformations());
    ...
    public void testXQueryViewWithXMLInput() {
        // Create query 
    ...
    public void testXQueryViewWithScalarInputs() {
        // Create query 
    ...
    public void testXQueryViewWithScalarInputCallingDocWithBuiltSQL() {
    ...
    public void testXQueryViewCallingMultipleDocs() {
        // Create query - this query calls the specified proc and wraps the data 
    ...
    public void testXQueryViewWithXMLInAndOut() {
        // Create query - this query calls the specified proc and wraps the data 
    ...
    public void testNestedXQueryViews() {
        // Create query - this query calls the specified proc and wraps the data 
    ...
    public void testXQueryWithFunctionDefinition() {
        // Create query - this query calls the specified proc and wraps the data 
