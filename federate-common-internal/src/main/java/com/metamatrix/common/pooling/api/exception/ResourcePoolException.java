...
public class ResourcePoolException extends MetaMatrixException {
     ...
     */
    public ResourcePoolException( String code, String message ) {
        super( code, message );
    }
     ...
     */
    public ResourcePoolException( Throwable e, String message ) {
        super( e, message );
    }
     ...
     */
    public ResourcePoolException( Throwable e, String code, String message ) {
