...
public class BasicCryptor implements Cryptor {
    ...
    protected void initDecryptCipher() throws CryptoException {
        ...
        try {
            ...
            throw new CryptoException( e,  ErrorMessageKeys.CM_UTIL_ERR_0076, CommonPlugin.Util.getString(ErrorMessageKeys.CM_UTIL_ERR_0076, cipherAlgorithm ));
        } catch ( NoSuchPaddingException e ) {
            throw new CryptoException( ErrorMessageKeys.CM_UTIL_ERR_0077, CommonPlugin.Util.getString(ErrorMessageKeys.CM_UTIL_ERR_0077, cipherAlgorithm, e.getClass().getName(),  e.getMessage() ));
    ...
    protected void initEncryptCipher() throws CryptoException {
        ...
        try {
            ...
            throw new CryptoException(e, ErrorMessageKeys.CM_UTIL_ERR_0072, CommonPlugin.Util.getString(ErrorMessageKeys.CM_UTIL_ERR_0077, cipherAlgorithm , e.getMessage() ));
        } catch ( InvalidKeyException e ) {
