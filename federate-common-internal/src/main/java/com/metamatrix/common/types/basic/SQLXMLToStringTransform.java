...
public class SQLXMLToStringTransform extends AnyToStringTransform {
    ...
    public Object transform(Object value) throws TransformationException {
        ...
        try {       
            ...
            throw new TransformationException(e, CommonPlugin.Util.getString("failed_convert", new Object[] {getSourceType().getName(), getTargetType().getName()})); //$NON-NLS-1$            
        } catch(InvalidReferenceException e) {
            throw new TransformationException(e, CommonPlugin.Util.getString("remote_lob_access")); //$NON-NLS-1$
        } catch (IOException e) {
            throw new TransformationException(e, CommonPlugin.Util.getString("failed_convert", new Object[] {getSourceType().getName(), getTargetType().getName()})); //$NON-NLS-1$
        }
    }
