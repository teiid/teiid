...
public class LogonImpl implements ILogon {
	...
	public LogonResult logon(Properties connProps) throws LogonException {
		...
		AuthenticationType authType = validateAuthType(vdbName,vdbVersion, preferredAuthType);
	...
	private AuthenticationType validateAuthType(String vdbName, String vdbVersion, AuthenticationType preferredAuthType) {
		...
		if (preferredAuthType != null && !preferredAuthType.equals(authType) && !preferredAuthType.equals(AuthenticationType.ANY)) {
			 LogManager.logInfo(LogConstants.CTX_SECURITY, RuntimePlugin.Util.gs(RuntimePlugin.Event.TEIID40118, authType.name()));
		}
		return authType;
	}
	...
	public AuthenticationType getAuthenticationType(String vdbName, String version, AuthenticationType preferType) {
		return this.service.getAuthenticationType(vdbName, version, preferType);
	}
}
