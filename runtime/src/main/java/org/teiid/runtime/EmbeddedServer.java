	...
	static class AdminFactory {
		...
		private class AdminImpl implements Admin {
			...
			public Collection<? extends VDB> getVDBs() throws AdminException {
				return this.embeddedServer.repo.getVDBs();
			}
			...
			public Collection<String> getCacheTypes() throws AdminException {
				...
				cacheTypes.addAll(this.embeddedServer.rs.getCacheTypes());
				cacheTypes.addAll(this.embeddedServer.ppc.getCacheTypes());
				return cacheTypes;
			}

			@Override
			public Collection<? extends Session> getSessions() throws AdminException {
				return this.embeddedServer.sessionService.getActiveSessions();
			}

			@Override
			public Collection<? extends Request> getRequests() throws AdminException {
				return this.embeddedServer.dqp.getRequests();
			}

			@Override
			public Collection<? extends Request> getRequestsForSession(String sessionId) throws AdminException {
				return this.embeddedServer.dqp.getRequestsForSession(sessionId);
			}
