...
public interface BatchedExecution {
    /**
     * Get the next Batch of results from the execution.
     * @param maxBatchSize A maximum number of rows that can be 
     * returned in a single batch
     * @return A batch of 0 to <code>maxBatchSize</code> rows 
