...
public interface ConnectorCapabilities {
    ...
    /**
     * Class defining constants for the {@link ConnectorCapabilities#getCapabilitiesScope()}
     * method.
     * 
     * @deprecated
     */
    public static class SCOPE {
        /** 
         * The widest possible scope - these capabilities can be used for any 
         * user and will be cached after the first retrieval.  This is the recommended
         * scope to use. 
         */ 
        public static final int GLOBAL = 0;
    
        /**
         * This scope will re-retrieve the connector capabilities for each user 
         * and possibly per query.  This mode will defeat some important caching
         * optimizations and should be used with caution.
         */
    ...
    /**
     * Class defining constants for the {@link ConnectorCapabilities#supportsExecutionMode(int)}
     * method.
     */
    public static class EXECUTION_MODE {
        /** 
         * The most commonly supported mode - synchronous querying will use 
         * the {@link SynchQueryExecution} class to perform synchronous SELECT
         * queries.
         */ 
        public static final int SYNCH_QUERY = 0;
    
        /** 
         * This mode will use the {@link UpdateExecution} class to perform
         * INSERT, UPDATE, and DELETE commands. 
         */ 
        public static final int UPDATE = 1;

        /** 
         * This mode will use the {@link ProcedureExecution} class to perform
         * procedure executions. 
         */ 
        public static final int PROCEDURE = 2;
        
        /**
         * This mode will use the {@link BatchedUpdatesExecution} class to perform
         * batched INSERT, UPDATE, and DELETE commands.
         */
        public static final int BATCHED_UPDATES = 3;
        
        /**
         * This mode will use the {@link BatchedUpdatesExecution} class to perform
         * bulk INSERT where single insert command and multiple values
         */
        public static final int BULK_INSERT = 4;
                
        /** 
         * This mode will use the {@link AsynchQueryExecution} class to perform 
         * an asynchronous SELECT queries and poll for results.
         */ 
        public static final int ASYNCH_QUERY = 5;
        
        public static final int SYNCH_QUERYCOMMAND = 6;
        
        public static final int ASYNCH_QUERYCOMMAND = 7;
    ...
    /**
     * Specify the scope of this set of capabilities.  Specifying a 
     * wider scope results in better performance as the capabilities can
     * be more widely cached.  
     * @return Scope constant as defined in this interface
     * @see ConnectorCapabilities.SCOPE#GLOBAL
     * @see ConnectorCapabilities.SCOPE#PER_USER
     * 
     * @deprecated Connectors with user specific capabilities should continue providing them off of 
     * {@link Connection} objects rather than implementing {@link GlobalCapabilitiesProvider}
     */
    int getCapabilitiesScope();

    /**
     * Determine whether a particular execution mode is supported by this
     * connector.    
     * @param executionMode Execution mode, as defined in the {@link ConnectorCapabilities.EXECUTION_MODE} constants
     * @return True if mode is supported, false if it is not
     * @see ConnectorCapabilities.EXECUTION_MODE#SYNCH_QUERY
     * @see ConnectorCapabilities.EXECUTION_MODE#UPDATE
     * @see ConnectorCapabilities.EXECUTION_MODE#PROCEDURE
     * @since 4.0
     */
