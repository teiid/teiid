...
/** 
 * The AsynchQueryExecution interface works much like the {@link com.metamatrix.data.api.SynchQueryExecution}
 ...
 * @since 4.3.3
 * 
 * @deprecated {@link AsynchQueryCommandExecution}
 */
public interface AsynchQueryExecution extends
                                     Execution,
                                     BatchedExecution {
     ...
     */
    void executeAsynch( IQuery query, int maxBatchSize ) throws ConnectorException;
