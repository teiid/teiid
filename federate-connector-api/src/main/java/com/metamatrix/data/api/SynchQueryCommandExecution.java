 ...
 */
public interface SynchQueryCommandExecution extends Execution, BatchedExecution {
     ...
     */
    void execute( IQueryCommand query, int maxBatchSize ) throws ConnectorException;
