...
@Singleton
public class VMControllerIDImpl implements VMControllerID, Serializable {
    
	private long id;
    private String hostName;

    @Inject
    public VMControllerIDImpl(@Named(Configuration.VMID)long id, @Named(Configuration.HOSTNAME)String hostName) {
        this.id = id;
