...
public interface EventSource {
    ...
    void addListener(Class eventClass, EventObjectListener listener)
        throws EventSourceException;

    void addListener(EventObjectListener listener)
        throws EventSourceException;

    void removeListener(Class eventClass, EventObjectListener listener)
        throws EventSourceException;
    ...
    /**
     * Obtain those listeners that are registered for <i>all</i> event classes
     * (i.e., those that use the <code>addListener(EventObjectListener)</code>
     * method).
     */
    List getListeners();
     ...
     * The resulting list contains no duplicates.
     */
