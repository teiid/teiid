...
public class UnsupportedCredentialException extends MetaMatrixSecurityException {
     ...
     */
    public UnsupportedCredentialException( String code, String message ) {
        super( code, message );
    }
     ...
     */
    public UnsupportedCredentialException( Throwable e, String message ) {
        super( e, message );
    }
     ...
     * @param code A code denoting the exception
     */
    public UnsupportedCredentialException( Throwable e, String code, String message ) {
