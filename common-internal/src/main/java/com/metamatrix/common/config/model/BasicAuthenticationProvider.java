...
public class BasicAuthenticationProvider extends BasicComponentDefn implements AuthenticationProvider, Serializable {
    ...
    public BasicAuthenticationProvider(ConfigurationID configurationID, AuthenticationProviderID componentID, ComponentTypeID typeID) {
    ...
    public String getAuthenticationDomainClass() {       
        return this.getProperty(AuthenticationProviderType.Attributes.AUTHDOMAIN_CLASS);
    }

    public boolean isActivated() {
    	String activateStr = this.getProperty(AuthenticationProviderType.Attributes.ACTIVATE_STATUS);
    	return Boolean.getBoolean(activateStr);
    }
    //********************************************************
}
