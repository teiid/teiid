...
public interface AuthenticationProviderType extends ComponentType {
    ...
    public static final String AUTHPROVIDER_TYPE_NAME = "AuthenticationProvider"; //$NON-NLS-1$
    public static final ComponentTypeID AUTHPROVIDER_TYPE_ID = new ComponentTypeID(AUTHPROVIDER_TYPE_NAME);
    
    public interface Attributes {
        public static final String AUTHDOMAIN_CLASS = "AuthDomainClass";//$NON-NLS-1$
        public static final String ACTIVATE_STATUS = "Activate"; //$NON-NLS-1$
    }
