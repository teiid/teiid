...
public class InvalidPropertyValueException extends InvalidStringValueException {
     ...
     */
    public InvalidPropertyValueException(Throwable e) {
        super(e);
    }
    /**
     ...
     * @param e the exception that is encapsulated by this exception
     */
    public InvalidPropertyValueException( Throwable e, String message ) {
        super(e, message);
    }
    /**
     ...
     * @param code    The error code 
     */
    public InvalidPropertyValueException( Throwable e, String code, String message ) {
