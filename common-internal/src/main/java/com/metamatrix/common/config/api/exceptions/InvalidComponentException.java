...
public class InvalidComponentException extends InvalidConfigurationException {
     ...
     */
    public InvalidComponentException(Throwable e) {
        super(e);
    }
    /**
     ...
     * @param e the exception that is encapsulated by this exception
     */
    public InvalidComponentException( Throwable e, String message ) {
        super(e, message);
    }
    /**
     ...
     * @param code    The error code 
     */
    public InvalidComponentException( Throwable e, String code, String message ) {
