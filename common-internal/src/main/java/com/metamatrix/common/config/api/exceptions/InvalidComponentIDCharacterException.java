...
public class InvalidComponentIDCharacterException extends InvalidComponentIDFormatException {
     ...
     */
    public InvalidComponentIDCharacterException(String message) {
	super(message);
    }
    /**
     ...
     */
    public InvalidComponentIDCharacterException(Throwable e) {
        super(e);
    }
    /**
     ...
     * @param e the exception that is encapsulated by this exception
     */
    public InvalidComponentIDCharacterException( Throwable e, String message ) {
        super(e, message);
    }
    /**
     ...
     * @param code    The error code 
     */
    public InvalidComponentIDCharacterException( Throwable e, String code, String message ) {
