...
abstract public class InvalidStringValueException extends ConfigurationException {
     ...
     */
    public InvalidStringValueException(Throwable e) {
        super(e);
    }
    /**
     ...
     * @param e the exception that is encapsulated by this exception
     */
    public InvalidStringValueException( Throwable e, String message ) {
        super(e, message);
    }
    /**
     ...
     * @param code    The error code 
     */
    public InvalidStringValueException( Throwable e, String code, String message ) {
