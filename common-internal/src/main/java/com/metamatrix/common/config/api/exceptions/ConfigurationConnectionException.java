...
public class ConfigurationConnectionException extends ConfigurationException {
     ...
     */
    public ConfigurationConnectionException(String message) {
    	super(message);
    }
    /**
     ...
     */
    public ConfigurationConnectionException(Throwable e) {
        super(e);
    }
    /**
     ...
     * @param e the exception that is encapsulated by this exception
     */
    public ConfigurationConnectionException( Throwable e, String message ) {
        super(e, message);
    }
    /**
     ...
     * @param code    The error code 
     */
    public ConfigurationConnectionException( Throwable e, String code, String message ) {
