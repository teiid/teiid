...
public class InvalidVersionException extends ConfigurationException {
     ...
     */
    public InvalidVersionException(Throwable e) {
        super(e);
    }
    /**
     ...
     * @param e the exception that is encapsulated by this exception
     */
    public InvalidVersionException( Throwable e, String message ) {
        super(e, message);
    }
    /**
     ...
     * @param code    The error code 
     */
    public InvalidVersionException( Throwable e, String code, String message ) {
