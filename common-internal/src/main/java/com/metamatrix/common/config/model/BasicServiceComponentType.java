...
public class BasicServiceComponentType extends BasicComponentType implements ServiceComponentType {

    public BasicServiceComponentType(ComponentTypeID id, ComponentTypeID parentID, ComponentTypeID superID, boolean deployable, boolean deprecated, boolean monitored) {
        super(id, parentID, superID, deployable, deprecated, monitored);
    }

    BasicServiceComponentType(BasicServiceComponentType copy) {
        super(copy);
    }
