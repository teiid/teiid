...
public class ConnectorBindingID extends ServiceComponentDefnID {

    public ConnectorBindingID(ConfigurationID configID, String name) {
 		super(name);

    }
    protected ConnectorBindingID(String fullName) {
        super(fullName);
    }
