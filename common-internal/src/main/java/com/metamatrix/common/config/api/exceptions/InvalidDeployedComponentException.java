...
public class InvalidDeployedComponentException extends InvalidConfigurationException {

    /**
     * No-Arg Constructor
     */
    public InvalidDeployedComponentException(  ) {
        super( );
    }
     ...
     */
    public InvalidDeployedComponentException(String message) {
    	super(message);
    }
    /**
     ...
     */
    public InvalidDeployedComponentException(Throwable e) {
        super(e);
    }
    /**
     ...
     * @param e the exception that is encapsulated by this exception
     */
    public InvalidDeployedComponentException( Throwable e, String message ) {
        super(e, message);
    }
    /**
     ...
     * @param code    The error code 
     */
    public InvalidDeployedComponentException( Throwable e, String code, String message ) {
