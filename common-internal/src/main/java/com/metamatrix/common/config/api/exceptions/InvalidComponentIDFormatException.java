...
public class InvalidComponentIDFormatException extends ConfigurationException {
     ...
     */
    public InvalidComponentIDFormatException(String message) {
	super(message);
    }
    /**
     ...
     */
    public InvalidComponentIDFormatException(Throwable e) {
        super(e);
    }
    /**
     ...
     * @param e the exception that is encapsulated by this exception
     */
    public InvalidComponentIDFormatException( Throwable e, String message ) {
        super(e, message);
    }
    /**
     ...
     * @param code    The error code 
     */
    public InvalidComponentIDFormatException( Throwable e, String code, String message ) {
