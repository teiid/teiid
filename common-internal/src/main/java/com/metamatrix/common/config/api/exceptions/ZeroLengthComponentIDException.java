...
public class ZeroLengthComponentIDException extends InvalidComponentIDFormatException {
     ...
     */
    public ZeroLengthComponentIDException(String message) {
    	super(message);
    }
    /**
     ...
     */
    public ZeroLengthComponentIDException(Throwable e) {
        super(e);
    }
    /**
     ...
     * @param e the exception that is encapsulated by this exception
     */
    public ZeroLengthComponentIDException( Throwable e, String message ) {
        super(e, message);
    }
    /**
     ...
     * @param code    The error code 
     */
    public ZeroLengthComponentIDException( Throwable e, String code, String message ) {
