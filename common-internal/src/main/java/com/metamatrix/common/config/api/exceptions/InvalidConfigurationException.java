...
abstract public class InvalidConfigurationException extends ConfigurationException {
     ...
     * @param e the exception that is encapsulated by this exception
     */
    public InvalidConfigurationException( Throwable e, String message ) {
        super(e, message);
    }
    /**
     ...
     * @param code    The error code 
     */
    public InvalidConfigurationException( Throwable e, String code, String message ) {
