...
public class FolderDefinitionImpl extends ObjectDefinitionImpl implements FolderDefinition  {
     ...
     * @param name the name
     */
    public FolderDefinitionImpl(String name) {
        super(name);
    }
     ...
     * @param name the name
     */
    public FolderDefinitionImpl(String name, String displayName) {
    ...
    public int compareTo(Object obj) {
        FolderDefinitionImpl that = (FolderDefinitionImpl)obj; // May throw ClassCastException
        if (obj == null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.getClass().isInstance(obj)) {
            FolderDefinitionImpl that = (FolderDefinitionImpl)obj;
