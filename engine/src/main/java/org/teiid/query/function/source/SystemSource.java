...
public class SystemSource extends UDFSource implements FunctionCategoryConstants {
    ...
    private void addUnixTimeFunctions() {
    	functions.add(new FunctionMethod(SourceSystemFunctions.FROM_UNIXTIME, QueryPlugin.Util.getString("SystemSource.from_unixtime_description"), DATETIME, FUNCTION_CLASS, "from_unixtime", //$NON-NLS-1$ 
    	        new FunctionParameter[]{
    	            new FunctionParameter("unix_timestamp", DataTypeManager.DefaultDataTypes.INTEGER, QueryPlugin.Util.getString("SystemSource.from_unixtime_param1"))},
