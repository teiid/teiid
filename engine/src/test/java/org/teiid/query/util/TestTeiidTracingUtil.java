...
public class TestTeiidTracingUtil {
    ...
    @Test public void testTracing() {
        ...
        Span span = ttu.buildSpan(new CommandLogMessage(0, "", null, null, null, null, null, null, "", null), null);
        assertNotNull(span);
        
        span = ttu.buildSpan(new CommandLogMessage(0, "", null, null, null, null, null, null, "", null), "{\"spanid\":\"1\",\"traceid\":\"2\"}");
        assertNotNull(span);
    }
