...
public class TestProcErrors {
    ...
    @Test(expected=QueryResolverException.class) public void testErrorResolving() throws Exception {
		...
		String query = "create virtual procedure BEGIN atomic\n"
		...
		QueryResolver.resolveCommand(QueryParser.getQueryParser().parseCommand(query), metadata);
    }
    
    @Test public void testNestedBeginAtomicException() throws Exception {
		String ddl = "create virtual procedure proc2 () as BEGIN atomic\n"
