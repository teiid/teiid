...
public class RequestMessage implements Externalizable {
    ...
    private String vdbEditMode;
	private String schemaInContext;
	...
	public void readExternal(ObjectInput in) throws IOException,
		...
		try {
			// 9.1 property
			schemaInContext = (String)in.readObject();
			vdbEditMode = (String)in.readObject();
		} catch (OptionalDataException e) {
		} catch (EOFException e) {
		}
	}
    ...
    public String getSchemaInContext() {
		return schemaInContext;
	}

	public void setSchemaInContext(String schemaInContext) {
		this.schemaInContext = schemaInContext;
	}
	
    public boolean isVdbInEditMode() {
		return JDBCURL.isVDBInEditMode(this.vdbEditMode);
	}

	public void setVdbEditMode(String vdbEditMode) {
		this.vdbEditMode = vdbEditMode;
	}	
}
